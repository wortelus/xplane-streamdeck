...
| Aircraft                  | 15 keys | 32 keys | Stream Deck + |
|---------------------------|---------|---------|---------------|
| Cessna 172SP              | ❌       | ✅✅      | ❌             |
| Zibo 737-800              | ✅       | ✅✅      | ❌             |
| JARDesign A320            | ✅       | ❌       | ❌             |
...
- Rarely, the button dataref state may freeze for the entire _xplane_streamdeck_ session. While key press actions
  continue to function, the icons remain stuck. The workaround is to restart either xplane_streamdeck or the simulator
  session. The underlying _pyxpudpserver_ library is deemed to be the cause. I am aware of this and plan to address it
  in the near future.
